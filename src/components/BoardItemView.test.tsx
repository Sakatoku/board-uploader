...
describe("video item", () => {
  it("shows the video badge icon", () => {
    render(<BoardItemView boardId={BOARD_ID} item={makeVideo()} onDragStart={noop} onDelete={noop} onRename={noop} onEditText={noop} />);
    expect(screen.getByLabelText("動画")).toBeTruthy();
  });

  it("renders a video element", () => {
    const { container } = render(
      <BoardItemView boardId={BOARD_ID} item={makeVideo({ id: "video-id" })} onDragStart={noop} onDelete={noop} onRename={noop} onEditText={noop} />,
    );
  ...
  it("renders the 開く link", () => {
    render(<BoardItemView boardId={BOARD_ID} item={makeVideo({ id: "video-id" })} onDragStart={noop} onDelete={noop} onRename={noop} onEditText={noop} />);
...
describe("audio item", () => {
  it("shows the audio badge icon", () => {
    render(<BoardItemView boardId={BOARD_ID} item={makeAudio()} onDragStart={noop} onDelete={noop} onRename={noop} onEditText={noop} />);
    expect(screen.getByLabelText("音声")).toBeTruthy();
  });

  it("renders an audio element", () => {
    const { container } = render(
      <BoardItemView boardId={BOARD_ID} item={makeAudio({ id: "audio-id" })} onDragStart={noop} onDelete={noop} onRename={noop} onEditText={noop} />,
    );
...
describe("pdf item", () => {
  it("shows the pdf badge icon", () => {
    render(<BoardItemView boardId={BOARD_ID} item={makePdf()} onDragStart={noop} onDelete={noop} onRename={noop} onEditText={noop} />);
    expect(screen.getByLabelText("PDF")).toBeTruthy();
  });

  it("renders an iframe", () => {
    const { container } = render(
      <BoardItemView boardId={BOARD_ID} item={makePdf({ id: "pdf-id" })} onDragStart={noop} onDelete={noop} onRename={noop} onEditText={noop} />,
    );
  ...
  it("renders the 開く link", () => {
    render(<BoardItemView boardId={BOARD_ID} item={makePdf({ id: "pdf-id" })} onDragStart={noop} onDelete={noop} onRename={noop} onEditText={noop} />);
    expect(screen.getByText("開く")).toBeTruthy();
  });
});
...
describe("delete button", () => {
  it("renders a delete button on every item", () => {
    const { container } = render(
      <BoardItemView boardId={BOARD_ID} item={makeNote()} onDragStart={noop} onDelete={noop} onRename={noop} onEditText={noop} />,
    );
  ...
  it("calls onDelete with item id after confirm", () => {
    ...
    render(
      <BoardItemView boardId={BOARD_ID} item={makeNote()} onDragStart={noop} onDelete={onDelete} onRename={noop} onEditText={noop} />,
    );
...
describe("rename button", () => {
  ...
  it("calls onRename with the item when clicked", () => {
    ...
    const note = makeNote();
    render(
      <BoardItemView boardId={BOARD_ID} item={note} onDragStart={noop} onDelete={noop} onRename={onRename} onEditText={noop} />,
    );
...
describe("BoardItemView", () => {
  describe("note item", () => {
    it("renders the note text", () => {
      render(<BoardItemView boardId={BOARD_ID} item={makeNote()} onDragStart={noop} onDelete={noop} onRename={noop} onEditText={noop} />);
    ...
    it("renders at the item's x/y position", () => {
      const { container } = render(
        <BoardItemView boardId={BOARD_ID} item={makeNote({ x: 120, y: 240 })} onDragStart={noop} onDelete={noop} onRename={noop} onEditText={noop} />,
      );
    ...
    it("renders markdown in the note text", () => {
      const { container } = render(
        <BoardItemView
          boardId={BOARD_ID}
          item={makeNote({ text: "# Heading\n**bold**" })}
          onDragStart={noop}
          onDelete={noop}
          onRename={noop}
          onEditText={noop}
    ...
    it("calls onEditText with the item when the note body is clicked", () => {
      const onEditText = vi.fn();
      const note = makeNote();
      render(
        <BoardItemView boardId={BOARD_ID} item={note} onDragStart={noop} onDelete={noop} onRename={noop} onEditText={onEditText} />,
      );
      (document.querySelector(".note-text") as HTMLElement).click();
      expect(onEditText).toHaveBeenCalledWith(note);
    });
  });

  describe("image item", () => {
    it("shows the image badge icon", () => {
      render(<BoardItemView boardId={BOARD_ID} item={makeImage()} onDragStart={noop} onDelete={noop} onRename={noop} onEditText={noop} />);
      expect(screen.getByLabelText("画像")).toBeTruthy();
    });

    it("renders the image element", () => {
      const { container } = render(
        <BoardItemView boardId={BOARD_ID} item={makeImage()} onDragStart={noop} onDelete={noop} onRename={noop} onEditText={noop} />,
      );
      expect(container.querySelector("img")).toBeTruthy();
    });

    it("renders the download link", () => {
      render(<BoardItemView boardId={BOARD_ID} item={makeImage({ id: "img-id" })} onDragStart={noop} onDelete={noop} onRename={noop} onEditText={noop} />);
    ...
    it("formats size in KB", () => {
      render(<BoardItemView boardId={BOARD_ID} item={makeImage({ size: 2048 })} onDragStart={noop} onDelete={noop} onRename={noop} onEditText={noop} />);
  ...
  describe("file item (non-image)", () => {
    it("shows the file badge icon", () => {
      render(<BoardItemView boardId={BOARD_ID} item={makeFile()} onDragStart={noop} onDelete={noop} onRename={noop} onEditText={noop} />);
      expect(screen.getByLabelText("ファイル")).toBeTruthy();
    });

    it("does not render an image element", () => {
      const { container } = render(
        <BoardItemView boardId={BOARD_ID} item={makeFile()} onDragStart={noop} onDelete={noop} onRename={noop} onEditText={noop} />,
      );
    ...
    it("formats size in MB", () => {
      render(<BoardItemView boardId={BOARD_ID} item={makeFile({ size: 1024 * 1024 })} onDragStart={noop} onDelete={noop} onRename={noop} onEditText={noop} />);
      expect(screen.getByText(/1\.0 MB/)).toBeTruthy();
    });

    it("formats size in bytes when under 1 KB", () => {
      render(<BoardItemView boardId={BOARD_ID} item={makeFile({ size: 512 })} onDragStart={noop} onDelete={noop} onRename={noop} onEditText={noop} />);
